...
export function TagInputAutocompleteDropDown() {
  ...
  const {isDropdownOpen, setInputValue, setSuggestions, setIsDropdownOpen,setActiveSuggestionIndex, activeSuggestionIndex, suggestions} = useTagInputAutoCompleteContext();
